...
BookMeta = namedtuple('BookMeta', 'file_path, extension, title, author, cover, description, tags, series, '
                                  'series_id, languages, publisher, pubdate, identifiers, is_audio')

# python build process likes to have x.y.zbw -> b for beta and w a counting number
STABLE_VERSION = {'version': '0.6.24b'}

NIGHTLY_VERSION = dict()
NIGHTLY_VERSION[0] = 'b38e58c5ca591efb906cf661d82a968316481d41'
NIGHTLY_VERSION[1] = '2024-12-03T00:06:53Z'
...
GCS_BUCKET_NAME = 'speechmatic-library'
GCS_PROJECT_ID = 'speechmatic-prod'
